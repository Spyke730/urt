    ...
    <div class="col-sm-9 col-sm-offset-1">
      ...
      <div class="wizard-container">
        <div class="card wizard-card ct-wizard-orange" id="wizardProfile">
          {{ form('id':'encuestaURT', 'name':'encuestaURT', 'encuesta/nuevo', 'method':'post', 'autocomplete':"off") }}
              ...
              <div class="tab-pane" id="capituloI">
                <div class="row">
                  ...
                  <div class="col-xs-12">
                    <div class="box box-solid">
                      <div class="box-header">
                        <label class="box-title"><small style="color:black">3. ¿Cuanto tiempo de experiencia laboral tiene en su cargo actual?  - Desde que inicio a trabajar en su campo actual.</small></label>
                      </div>
                      <div class="box-body">
                        <div class="form-group">
                          <div class="row">
                  ...
                  <div class="col-xs-12">
                    <div class="box box-solid">
                      ...
                      <div class="box-body">
                        ...
                        <div class="form-group">
                          <div>
                            <label class="control-label">d. El aplicativo para el registro de demandas</label>
                          </div>
                        </div>
                        <div class="form-group">
                          <div class="radio">
              ...
              <div class="tab-pane" id="capituloPW">
                <div class="row">
                  ...
                  <div class="col-xs-12">
                    <div class="box box-solid">
                      <div class="box-header">
                        <label class="box-title"><small style="color:black">35. ¿Con qué frecuencia consulta la <b>página web</b> de la URT?</small></label>
                      </div>
                      <div class="box-body">
                        <div class="form-group">
                          <div class="row">
                  ...
                  <div class="col-xs-12"  id="pregunta36" style="display: none">
                    <div class="box box-solid">
                      <div class="box-header">
                        <label class="box-title"><small style="color:black">36. En una escala de 1 a 10, donde 1 es muy malo y 10 muy bueno. Califique los siguientes aspectos acerca de la página web de la URT.</small></label>
                      </div>
                      <div class="box-body">
                        <div class="form-group">
                          <div>
              ...
              <div class="tab-pane" id="capituloX">
                <div class="row">
                  ...
                  <div class="col-xs-12">
                    <div class="box box-solid">
                      <div class="box-header">
                        <label class="box-title"><small style="color:black">37. ¿A cuál territorial de la URT se encuentra usted vinculado actualmente?</small></label>
                      </div>
                      <div class="box-body">
                        <div class="form-group">
                          <div>
                  ...
                  <div class="col-xs-12">
                    <div class="box box-solid">
                      <div class="box-header">
                        <label class="box-title"><small style="color:black">38. ¿Cuál es su cargo en la URT?</small></label>
                      </div>
                      <div class="box-body">
                        <div class="form-group">
                          <div class="row">
                  ...
                  <div class="col-xs-12">
                    <div class="box box-solid">
                      <div class="box-header">
                        <label class="box-title"><small style="color:black">39. ¿A cuál dependencia de la URT se encuentra usted vinculado actualmente?</small></label>
                      </div>
                      <div class="box-body">
                        <div class="form-group">
                          <div class="row">
                            <div class="col-xs-4">
                              ...
                              <option value="">Seleccione ...</option>
                              <option value="1">Dirección Jurídica de Restitución</option>
                              <option value="2">Dirección Social</option>
                              <option value="3">Dirección de asuntos étnicos</option>
                              <option value="4">Dirección catastral y de análisis territorial</option>
                              <option value="5">Direcciones territoriales</option>
                              <option value="6">Oficina de tecnologías de la información</option>
                              <option value="7">Oficina asesora de planeación</option>
                              <option value="8">Oficina asesora de comunicaciones</option>
                              <option value="9">Oficina de control interno</option>
                              <option value="10">No informa</option>
                              </select>
                            </div>
                          </div>
