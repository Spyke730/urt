...
class Acl extends Component
{
     ...
     * @var string
     */
    private $filePath = '/cache/acl/estadatsas.txt';
    ...
    public function getAcl()
    {
        ...
        if (function_exists('apc_store')) {
            apc_store('Estadatsas-acl', $this->acl);
        }
    ...
    public function rebuild()
    {
        ...
        if (touch(APP_DIR . $this->filePath) && is_writable(APP_DIR . $this->filePath)) {
            ...
            // Store the ACL in APC
            if (function_exists('apc_store')) {
                apc_store('Estadatsas-acl', $acl);
            }
        } else {
            $this->flash->error(
                'El usuario no tiene permisos para crear el listado ACL ' . APP_DIR . $this->filePath
            );
        }
