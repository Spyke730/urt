	...
	<section id="about" class="container content-section text-center">
		<div class="row">
			<div class="col-lg-8 col-lg-offset-2">
				<h2>Encuesta de satisfacción con el proceso de solicitud de Restitución de tierras - 2015</h2>
